...
export enum ButtonTheme {
  CLEAR = '',
  OUTLINE = 'cursor-pointer rounded-[20px] px-[27px] py-[17px] bg-white dark:bg-dark-bg-content dark:hover:outline hover:outline hover:outline-[1px] outline-[1px] hover:outline-gray-text',
}
