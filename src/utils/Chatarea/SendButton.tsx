...
const SendButton = (props: svgProps) => {
    ...
    return (
        <button className=" flex justify-center items-center cursor-pointer  border-2 bg-white dark:bg-dark-bg-content  rounded-[20px] border-green min-w-[42px] min-h-[42px] hover:border-gray-text">
