...
const CommentEdit = (props: { id: number | undefined, data: { content: string, img: string } }) => {
    ...
    return (
        <>
            <Modal isOpen={isModalOpen} onClose={closeModal}>
                <EditCommentForm data={props.data} mutate={handleMutate} id={props.id} onClose={closeModal} />
            </Modal>
            <section className="absolute  top-0  right-0 pl-4  ">
                <div className="p-1 bg-white border-gray-text rounded-[20px] border dark:bg-dark-bg">
                    <button onClick={openModal} className="flex p-2 gap-4 text-[14px] items-center">
                        ...
                        <p className="whitespace-nowrap">Редактировать </p>
                    </button>
                    <button onClick={handleDelete} className="flex p-2 text-[14px] gap-4 items-center">
