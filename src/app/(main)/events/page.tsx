...
const Event = ({ props }: { props: EventProps }) => {
    return (
        <div className="p-4 w-[500px] flex  bg-bg-content dark:bg-dark-bg-content rounded-[20px]">
            ...
            <div className="text-wrap flex grow flex-col">
                <p className="mt-[2px] font-bold  text-[16px]">
                    {props.title.substring(0, 30)}
                    {props.title.length > 30 ? '...' : ''}
                </p>
                <p className="text-sm text-gray-text ">
                    {props.descr.substring(0, 1000)}
                    {props.descr.length > 1000 ? '...' : ''}
                </p>
                <p className="mt-2 flex  items-center gap-2 text-sm text-gray-text ">
        ...
        <div className="overflow-auto w-full mt-[20px]">
            <div className="overflow-auto">
                ...
                <div className="flex  gap-4 overflow-x-auto ">
                    <Event props={{ title: 'Приглашение на квест', descr: "The most powerfull event, where u can see", avatar: 'https://i.pinimg.com/564x/70/23/12/702312fc8a652717239781260bf09809.jpg' }} />
            ...
            <div className="flex text-lg mt-8 mb-4">
                ...
                {/* <button className="hover:underline text-green ml-[50%]">
                        Посмотреть все
                    </button> */}
            </div>
            <div className="flex gap-4">
                <Event props={{ title: 'Название группы Название группы Название группы', descr: "Описание", avatar: 'https://i.pinimg.com/564x/70/23/12/702312fc8a652717239781260bf09809.jpg' }} />
                <Event props={{ title: 'Название группы', descr: "ОписаниеНазвание группыНазвание группы", avatar: 'https://i.pinimg.com/564x/70/23/12/702312fc8a652717239781260bf09809.jpg' }} />
            </div>
