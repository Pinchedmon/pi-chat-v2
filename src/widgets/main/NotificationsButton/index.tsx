    ...
    return (
        <div className="relative">
            <div
                ...
                className="mr-[7px] md:mr-0   cursor-pointer flex border-2 bg-white dark:bg-dark-bg-content items-center justify-center rounded-[20px] border-green w-[42px] h-[42px] hover:border-gray-text">
